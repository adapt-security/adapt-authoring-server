...
class Router {
  ...
  */
  enableAPIMap() {
    if(this.checkHasInited(`${this.t('error.routeralreadyinited')}, ${this.t('error.noenablemap')}`)) {
      return;
    }
    this.addRoute({
      route: '/',
  ...
  */
  addRoute(...route) {
    const inited = this.checkHasInited(`${this.t('error.routeralreadyinited')}, ${this.t('error.nomoreroutes')}`);
  ...
  */
  createChildRouter(route) {
    if(this.checkHasInited(`${this.t('error.routeralreadyinited')}, ${this.t('error.nomorechildrouters')}`)) {
      return this;
    }
  ...
  */
  init() {
    if(this.checkHasInited(this.t('error.routeralreadyinited'))) {
      return;
    }
