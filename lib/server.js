...
class Server extends Module {
  constructor(app) {
    ...
    // only expose certain functions to the outside world
    ['use', 'listen'].forEach(func => {
      this[func] = expressApp[func].bind(expressApp);
    });
