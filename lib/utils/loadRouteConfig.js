...
export async function loadRouteConfig (rootDir, target, options = {}) {
  ...
  // Schema validation via the app's jsonschema module (handles $merge/$ref composition,
  // custom keywords, caching, and auto-discovery of schema files from all dependencies)
